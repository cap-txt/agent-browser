...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>AGENT_BROWSER_CAPTURE_MODE</code></td><td>Enable stream capture recorder mode. Set to <code>on</code> to write structured JSONL capture events.</td><td>(disabled)</td></tr>
