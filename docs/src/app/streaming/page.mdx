...
Streaming can also record human demonstration data as JSONL, including direct in-browser user actions and stream-injected input. Enable capture mode via environment variables:
